...
Ask the user: **"Where is the Planner export file? Please provide the full file path."**
- Suggest `C:\Users\guyboranyay\Downloads\Weekly Plan.xlsx` as the default if they want to use it.
- Wait for the user's response before proceeding.
- Use the path the user provides. If the file is not found at that path, tell the user and stop.
